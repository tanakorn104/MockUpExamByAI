...
def generate_quiz():
    try:
        ...
        5. โครงสร้างรายการ JSON (รวม 24 รายการ):
           ...
           - ลำดับที่ 21-24: เป็นประเภท "SHORT" (Case Study ขนาดใหญ่) โดยในโจทย์ต้องแบ่งเป็น 'Part A:' และ 'Part B:' ชัดเจน
        6. เฉลยและคำอธิบาย (detail): อธิบายทีละขั้นตอน (Step-by-step) อย่างละเอียดที่สุด พร้อมเหตุผลประกอบ
